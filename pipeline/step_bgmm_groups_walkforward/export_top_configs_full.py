#!/usr/bin/env python
"""
Export BGMM top_configs with full (non-truncated) feature lists.
"""
...
RESULTS_DIR = Path(r"D:\GitHub\bitcoin-probabilistic-learning\pipeline\step_bgmm_groups_walkforward\results")
...
def main() -> int:
    ...
    for split_id in needed_splits:
        ...
        if pre is None:
            continue
        _, feature_names, variances, abs_corr = pre
    ...
    for _, row in top_df.iterrows():
        ...
        feature_full_list.append(feats)
    top_df["Feature_List_Full"] = feature_full
    top_df["Feature_List_Full_List"] = feature_full_list

    out_json = RESULTS_DIR / "top_configs_full.json"

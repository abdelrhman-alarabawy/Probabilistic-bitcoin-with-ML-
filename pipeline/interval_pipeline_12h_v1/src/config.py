...
# Reuse gate module feature selection to keep preprocessing consistent.
...
USE_ENSEMBLE = False
ENSEMBLE_METHOD = "weighted"  # weighted | conservative
ENSEMBLE_FAMILIES = ["lightgbm", "xgboost", "quantile_forest", "sklearn"]

...
MIN_ACTION_SAMPLES = 30
MIN_ACTION_RATE = 0.08
MIN_PURITY_ACTIONABLE = 0.55
MIN_MARGIN = 0.08
MIN_DURATION = 3
MAX_LEAVE_PROB = 0.40
...
USE_ELIGIBILITY_CLASSIFIER = False

SWEEP_ACTION_RATES = [0.03, 0.05, 0.08, 0.10, 0.12]
SWEEP_PURITY = [0.50, 0.52, 0.54, 0.56, 0.58, 0.60]
SWEEP_MARGIN = [0.00, 0.05, 0.10, 0.15]
SWEEP_ENTROPY_MAX = [float("inf"), 0.80, 0.70, 0.60]
SWEEP_DECISION_THRESHOLD = [0.80, 0.90, 0.95]
